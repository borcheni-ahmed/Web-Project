...
if ($category_id) {
    $total_products_sql = "SELECT COUNT(*) FROM products WHERE category_id = :category_id";
    ...
    <main>
        <div class="products-container">
            ...
            <div class="pagination">
                <?php if ($page > 1): ?>
                    <a href="products.php?page=<?php echo $page - 1; ?>&category=<?php echo $category_id; ?>">Previous</a>
                <?php endif; ?>

                <?php for ($i = 1; $i <= $total_pages; $i++): ?>
                    <a
                        href="products.php?page=<?php echo $i; ?>&category=<?php echo $category_id; ?>"
                ...
                <?php if ($page < $total_pages): ?>
                    <a href="products.php?page=<?php echo $page + 1; ?>&category=<?php echo $category_id; ?>">Next</a>
                <?php endif; ?>
            </div>
        </div>
    </main>
